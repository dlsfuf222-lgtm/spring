결론부터 정리하면 다음과 같습니다.
## “property”라는 용어는 두 가지 전혀 다른 의미로 사용된다 ##
...
>> 환경 설정값(Environment/Configuration Property)
 >> 자바 실행을 위한 외부 Key–Value 설정
...
>> Java Bean Property
 >> 클래스 내부 속성 + getter/setter로 외부에 노출되는 논리적 속성
## 두 용어는 이름만 같고 전혀 다른 개념  ##
